...
files_2m_temperature_max <- list.files(
  path = "/media/raphaelsaldanha/lacie/era5land_daily_africa/2m_temperature_max/2024/",
  pattern = ".nc$",
  full.names = TRUE
)

files_2m_temperature_min <- list.files(
  path = "/media/raphaelsaldanha/lacie/era5land_daily_africa/2m_temperature_min/2024/",
  pattern = ".nc$",
  full.names = TRUE
)

files_2m_temperature_mean <- list.files(
  path = "/media/raphaelsaldanha/lacie/era5land_daily_africa/2m_temperature_mean/2024/",
  pattern = ".nc$",
  full.names = TRUE
)

files_total_precipitation <- list.files(
  path = "/media/raphaelsaldanha/lacie/era5land_daily_africa/total_precipitation/2024/",
  pattern = ".nc$",
  full.names = TRUE
)

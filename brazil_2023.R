...
files_2m_temperature_max <- list.files(
  path = "/media/raphael/lacie/era5land_daily_latin_america/data_2023/2m_temperature_max/", 
  pattern = ".nc$",
  full.names = TRUE
)

files_2m_temperature_min <- list.files(
  path = "/media/raphael/lacie/era5land_daily_latin_america/data_2023/2m_temperature_min/", 
  pattern = ".nc$",
  full.names = TRUE
)

files_2m_temperature_mean <- list.files(
  path = "/media/raphael/lacie/era5land_daily_latin_america/data_2023/2m_temperature_mean/", 
  pattern = ".nc$",
  full.names = TRUE
)

files_2m_dewpoint_temperature <- list.files(
  path = "/media/raphael/lacie/era5land_daily_latin_america/data_2023/2m_dewpoint_temperature/", 
  pattern = ".nc$",
  full.names = TRUE
)

files_10m_u_component_of_wind <- list.files(
  path = "/media/raphael/lacie/era5land_daily_latin_america/data_2023/10m_u_component_of_wind/", 
  pattern = ".nc$",
  full.names = TRUE
)

files_10m_v_component_of_wind <- list.files(
  path = "/media/raphael/lacie/era5land_daily_latin_america/data_2023/10m_v_component_of_wind/", 
  pattern = ".nc$",
  full.names = TRUE
)

files_surface_pressure <- list.files(
  path = "/media/raphael/lacie/era5land_daily_latin_america/data_2023/surface_pressure/", 
  pattern = ".nc$",
  full.names = TRUE
)

files_total_precipitation <- list.files(
  path = "/media/raphael/lacie/era5land_daily_latin_america/data_2023/total_precipitation/", 
  pattern = ".nc$",
  full.names = TRUE
)
...
list(
  ...
  tar_target(
    ...
    command = compute_zonal_statistics(
      ...
      sf_geom = mun_geom,
      zonal_list <- z1,
      db_file = "output_data/data_2023/max_temperature_data.sqlite"
    ),
    format = "file",
  ...
  tar_target(
    ...
    command = sqlite2duckdb(
      ...
      duckdb_db = "output_data/data_2023/max_temperature_data.duckdb"
    ),
    format = "file"
  ),
  tar_target(
    ...
    command = duckdb2parquet(
      ...
      parquet_path = "output_data/data_2023/parquet/"
    ),
    format = "file"
  ),
  ...
  tar_target(
    ...
    command = compute_zonal_statistics(
      ...
      sf_geom = mun_geom,
      zonal_list <- z1,
      db_file = "output_data/data_2023/min_temperature_data.sqlite"
    ),
    format = "file",
    cue = tar_cue(file = FALSE)
  ),
  tar_target(
    ...
    command = sqlite2duckdb(
      ...
      duckdb_db = "output_data/data_2023/min_temperature_data.duckdb"
    ),
    format = "file"
  ),
  tar_target(
  ...
  tar_target(
    ...
    command = compute_zonal_statistics(
      ...
      sf_geom = mun_geom,
      zonal_list <- z1,
      db_file = "output_data/data_2023/mean_temperature_data.sqlite"
    ),
    format = "file",
    cue = tar_cue(file = FALSE)
  ),
  tar_target(
    ...
    command = sqlite2duckdb(
      ...
      duckdb_db = "output_data/data_2023/mean_temperature_data.duckdb"
    ),
    format = "file"
  ),
  tar_target(
  ...
  tar_target(
    ...
    command = compute_zonal_statistics(
      ...
      sf_geom = mun_geom,
      zonal_list <- z1,
      db_file = "output_data/data_2023/dewpoint_temperature_data.sqlite"
    ),
    format = "file",
    cue = tar_cue(file = FALSE)
  ),
  tar_target(
    ...
    command = sqlite2duckdb(
      ...
      duckdb_db = "output_data/data_2023/dewpoint_temperature_data.duckdb"
    ),
    format = "file"
  ),
  tar_target(
  ...
  tar_target(
    ...
    command = compute_zonal_statistics(
      ...
      sf_geom = mun_geom,
      zonal_list <- z1,
      db_file = "output_data/data_2023/u_component_of_wind_data.sqlite"
    ),
    format = "file",
    cue = tar_cue(file = FALSE)
  ),
  tar_target(
    ...
    command = sqlite2duckdb(
      ...
      duckdb_db = "output_data/data_2023/u_component_of_wind_data.duckdb"
    ),
    format = "file"
  ),
  tar_target(
  ...
  tar_target(
    ...
    command = compute_zonal_statistics(
      ...
      sf_geom = mun_geom,
      zonal_list <- z1,
      db_file = "output_data/data_2023/v_component_of_wind_data.sqlite"
    ),
    format = "file",
    cue = tar_cue(file = FALSE)
  ),
  tar_target(
    ...
    command = sqlite2duckdb(
      ...
      duckdb_db = "output_data/data_2023/v_component_of_wind_data.duckdb"
    ),
    format = "file"
  ),
  tar_target(
  ...
  tar_target(
    ...
    command = compute_zonal_statistics(
      ...
      sf_geom = mun_geom,
      zonal_list <- z1,
      db_file = "output_data/data_2023/surface_pressure_data.sqlite"
    ),
    format = "file",
    cue = tar_cue(file = FALSE)
  ),
  tar_target(
    ...
    command = sqlite2duckdb(
      ...
      duckdb_db = "output_data/data_2023/surface_pressure_data.duckdb"
    ),
    format = "file"
  ),
  tar_target(
  ...
  tar_target(
    ...
    command = compute_zonal_statistics(
      ...
      sf_geom = mun_geom,
      zonal_list <- z2,
      db_file = "output_data/data_2023/total_precipitation_data.sqlite"
    ),
    format = "file",
    cue = tar_cue(file = FALSE)
  ),
  tar_target(
    ...
    command = sqlite2duckdb(
      ...
      duckdb_db = "output_data/data_2023/total_precipitation_data.duckdb"
    ),
    format = "file"
  ),
  tar_target(
